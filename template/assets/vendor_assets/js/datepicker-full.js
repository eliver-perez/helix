!(function () {
    ...
    if (!Event.prototype.composedPath) {
        const e = (t, i = []) => {
            ...
            return (
                i.push(t),
                t.parentNode ? (s = t.parentNode) : t.host ? (s = t.host) : t.defaultView && (s = t.defaultView),
                s ? e(s, i) : i
            );
        };
    ...
    function se(e, i) {
        ...
        if (
            (ie(s, "calendarWeeks", "weekNumbers", (e) => (e ? 1 : 0)),
            ie(s, "clearBtn", "clearButton"),
            ie(s, "todayBtn", "todayButton"),
            ie(s, "todayBtnMode", "todayButtonMode"),
            s.language)
        ) {
            let e;
            if (
                (s.language !== l &&
                    (a[s.language] ? (e = s.language) : ((e = s.language.split("-")[0]), a[e] || (e = !1))),
                delete s.language,
                e)
            ) {
                l = n.language = e;
                const t = h || a[q];
                (h = Object.assign({ format: z, weekStart: X }, a[q])),
                    l !== q && Object.assign(h, a[l]),
                    (n.locale = h),
                    d === t.format && (d = n.format = h.format),
                    y === t.weekStart && (y = Z(h.weekStart, n, g));
            }
        }
        if (s.format) {
        ...
        "pickLevel" in s && ((D = te(s.pickLevel, m, 2)), delete s.pickLevel),
            D !== m &&
                (D > m && ("minDate" in s || (s.minDate = p), "maxDate" in s || (s.maxDate = u)),
                o && !s.datesDisabled && (s.datesDisabled = []),
                (m = n.pickLevel = D));
        let k = p,
            x = u;
        if ("minDate" in s) {
        ...
        if (
            ("maxDate" in s &&
                ((x = null === s.maxDate ? void 0 : ee(s.maxDate, d, h, x)),
                void 0 !== x && (x = b(x, m, !0)),
                delete s.maxDate),
            x < k
                ? ((p = n.minDate = x), (u = n.maxDate = k))
                : (p !== k && (p = n.minDate = k), u !== x && (u = n.maxDate = x)),
            s.datesDisabled)
        ) {
        ...
        if (
            (s.daysOfWeekDisabled &&
                ((n.daysOfWeekDisabled = s.daysOfWeekDisabled.reduce(G, [])), delete s.daysOfWeekDisabled),
            s.daysOfWeekHighlighted &&
                ((n.daysOfWeekHighlighted = s.daysOfWeekHighlighted.reduce(G, [])), delete s.daysOfWeekHighlighted),
            "weekNumbers" in s)
        ) {
            let e = s.weekNumbers;
            if (e) {
        ...
        let M = f;
        "maxView" in s && ((M = te(s.maxView, f)), delete s.maxView),
            (M = m > M ? m : M),
            M !== f && (f = n.maxView = M);
        let O = w;
        if (
            ("startView" in s && ((O = te(s.startView, O)), delete s.startView),
            O < m ? (O = m) : O > f && (O = f),
            O !== w && (n.startView = O),
            s.prevArrow)
        ) {
        ...
        if (
            ("disableTouchKeyboard" in s &&
                ((n.disableTouchKeyboard = "ontouchstart" in document && !!s.disableTouchKeyboard),
    ...
    class ce {
        ...
        renderCell(e, t, i, s, { selected: n, range: a }, r, o = []) {
            ...
            if (
                ...
                d.add(...o),
                (r || this.checkDisabled(s, this.id)) && this.setDisabled(s, d),
                a)
            ) {
                const [e, t] = a;
                i > e && i < t && d.add("range"), i === e && d.add("range-start"), i === t && d.add("range-end");
            }
            n.includes(i) && d.add("selected");

            const visualFocus = this.selectedFocus;
            if (visualFocus !== undefined && visualFocus === i) {
                d.add("focused");
            }

            this.beforeShow && this.performBeforeHook(e, s);
        }
        refreshCell(e, t, i, [s, n]) {
            ...
            const visualFocus = this.selectedFocus ?? this.focused;
            t === visualFocus && a.add("focused");
        }
        changeFocusedCell(e) {
    ...
    class le extends ce {
        ...
        setOptions(e) {
            ...
            if (
                ...
                if (e.weekNumbers && !this.weekNumbers) {
                    ...
                    (this.weekNumbers = { element: e, dow: e.firstChild, weeks: e.lastChild }),
                        this.element.insertBefore(e, this.element.firstChild);
                } else
                    this.weekNumbers &&
                        !e.weekNumbers &&
                        (this.element.removeChild(this.weekNumbers.element), (this.weekNumbers = null));
            "getWeekNumber" in e && (this.getWeekNumber = e.getWeekNumber),
                "showDaysOfWeek" in e &&
                    (e.showDaysOfWeek
                        ? (_(this.dow), this.weekNumbers && _(this.weekNumbers.dow))
        ...
        updateSelection() {
            const { dates: e, rangepicker: t, lastSelectedDate: i } = this.picker.datepicker;
            this.selected = e;
            this.selectedFocus = i;
        ...
        render() {
            if (
                ...
                Array.from(this.weekNumbers.weeks.children).forEach((i, s) => {
                    const n = l(t, 7 * s);
                    (i.textContent = this.getWeekNumber(n, e)),
                        s > 3 && i.classList[n > this.last ? "add" : "remove"]("next");
                });
            }
            Array.from(this.grid.children).forEach((e, t) => {
                ...
                this.today === i && a.push("today"),
                    ...
                    this.renderCell(
                        ...
                        i,
                        this,
                        i < this.minDate || i > this.maxDate || this.daysOfWeekDisabled.includes(n),
                        a
                    );
            });
        }
    ...
    class ue extends ce {
        ...
        init(e, t = !0) {
            t &&
                ...
                this.grid.appendChild(A(a("span", 12, { "data-month": (e) => e }))),
                (this.first = 0),
                (this.last = 11)),
                super.init(e);
        }
        setOptions(e) {
            ...
            e.checkDisabled &&
                (this.checkDisabled = this.isMinView || null === e.datesDisabled ? e.checkDisabled : () => !1),
            ...
            if (
                ("minDate" in e &&
                    (void 0 === e.minDate
                        ...
                        : ((this.minYear = k(e.minDate, this.step)), (this.minDate = c(this.minYear, 0, 1)))),
                "maxDate" in e &&
                    (void 0 === e.maxDate
                        ? (this.maxYear = this.maxDate = void 0)
                        : ((this.maxYear = k(e.maxDate, this.step)), (this.maxDate = c(this.maxYear, 11, 31)))),
                e.checkDisabled &&
                    (this.checkDisabled = this.isMinView || null === e.datesDisabled ? e.checkDisabled : () => !1),
    ...
    function me(e, t) {
        ...
        o = n(o, i.minDate, i.maxDate);
        s.changeFocus(o).render();
    }
    function we(e) {
    ...
    function Ce(e, t) {
        if (
            ("title" in t &&
                (t.title
                    ? ((e.controls.title.textContent = t.title), _(e.controls.title))
    ...
    class Ae {
        constructor(e) {
            ...
            n.classList.add(`datepicker-${m}`),
                ...
                (this.views = [
                    ...
                    new fe(this, { id: 3, name: "decades", cellClass: "decade", step: 10 }),
                ]),
        ...
        show() {
            ...
            if (i) {
                const s = Be(i);
                s !== Be(L(t)) ? (t.dir = s) : t.dir && t.removeAttribute("dir"),
                    this.place(),
        ...
        place() {
            ...
            "auto" === f &&
                (o < y
                    ...
                    : o + i > k
                      ? ((f = "right"), k < c && (v = k - c))
                      : (f = "rtl" === Be(r) ? (c - i < y ? "left" : "right") : "left")),
                "right" === f && (m += h - i),
                (m += v),
        ...
        render(e = !0) {
            ...
            if (
                ...
                t[a](),
                s && (this.main.replaceChild(t.element, s.element), pe(i, "changeView")),
                !isNaN(n))
            ) {
                const e = new Date(this.viewDate);
                e.getFullYear() !== n.getFullYear() && pe(i, "changeYear"),
                    e.getMonth() !== n.getMonth() && pe(i, "changeMonth");
            }
        }
    }
    ...
    function Ye(e, t, i) {
        ...
        (o = Le(o, r, t < 0 ? -a : a, (e) => n.disabled.includes(e), n.minDate, n.maxDate)),
            void 0 !== o && s.changeFocus(o).render();
    }
    function We(e, t) {
        ...
        "ArrowLeft" === r
            ...
            : "ArrowRight" === r
              ...
              : "ArrowUp" === r
                ...
                : "ArrowDown" === r
                  ? p(1, !0)
                  : ("Backspace" === r || "Delete" === r || (r && 1 === r.length && !c)) && e.enterEditMode();
    }
    function _e(e) {
    ...
    function $e(e, t, i = !1) {
        ...
        let c = t.reduce((e, t) => {
            ...
            return (
                void 0 === i ||
                    ((i = b(i, o, r)),
                    !s(i, n.minDate, n.maxDate) ||
                        e.includes(i) ||
                        n.checkDisabled(i, o) ||
                        (!(o > 0) && n.daysOfWeekDisabled.includes(new Date(i).getDay())) ||
                        e.push(i)),
                e
            );
        }, []);
    ...
    function Pe(e, t, i) {
        ...
        (l || o) &&
            (l && l.toString() !== e.dates.toString()
                ? ((e.dates = l),
                (e.lastSelectedDate = l.length ? l[l.length - 1] : undefined),
                Ie(e, a ? 3 : 1, !0, c),
                pe(e, "changeDate"))
                : Ie(e, d ? 3 : 1, !0, c),
            r && e.hide());
    ...
    class Ue {
        constructor(e, t = {}, s = void 0) {
            (e.datepicker = this), (this.element = e), (this.dates = []), (this.lastSelectedDate = undefined);
            ...
            if (
                ("INPUT" === e.tagName
                    ? ((a = this.inputField = e),
                      ...
                      t.container &&
                          (n.container =
                              t.container instanceof HTMLElement ? t.container : document.querySelector(t.container)))
                    : (n.container = e),
                s)
            ) {
            ...
            const o = $e(this, r);
            o && o.length > 0 && ((this.dates = o), (this.lastSelectedDate = o[o.length - 1]));
            a && (a.value = He(this.dates, n));
        ...
        (window.DateRangePicker = class {
            constructor(e, t = {}) {
                ...
                i.forEach((e) => {
                    ...
                    a[0].dates.length > 0
                        ? ze(this, { target: i[0] })
                        : a[1].dates.length > 0 && ze(this, { target: i[1] });
            }
            setOptions(e) {
            ...
            setDates(e, t) {
                ...
                (this._updating = !0),
                    ...
                    s.dates[0] !== o ? ze(this, { target: a }) : i.dates[0] !== r && ze(this, { target: n });
            }
        });
})();
